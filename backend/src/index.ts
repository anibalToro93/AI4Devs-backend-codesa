...
import positionCandidatesRoutes from './routes/position-candidates.routes';
...
// Import and use position candidates routes
app.use('/positions', positionCandidatesRoutes);
